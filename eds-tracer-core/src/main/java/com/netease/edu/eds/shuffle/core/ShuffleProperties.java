 ...
 * * * 此时调用，或导致ShuffleProperties对象没有被ConfigurationPropertiesBindingPostProcessor处理。
 * 这些地方改成从Environment中直接获取。
 * 
...
public class ShuffleProperties {
	...
	/**
	 * wait 150ms to send message to latter environment to reduce cross environment
	 * consumer compete as less as possible.
	 */
	...
	private List<HttpClientRewriteRule> httpClientRewriteRules = new ArrayList<>();

	public List<HttpClientRewriteRule> getHttpClientRewriteRules() {
		return httpClientRewriteRules;
	}

	public void setHttpClientRewriteRules(
			List<HttpClientRewriteRule> httpClientRewriteRules) {
		this.httpClientRewriteRules = httpClientRewriteRules;
	}

	public static class HttpClientRewriteRule {
		private String match;
		private String routeToUri;
		...
		public String getRouteToUri() {
			return routeToUri;
		}

		public void setRouteToUri(String routeToUri) {
			this.routeToUri = routeToUri;
		}
	}
