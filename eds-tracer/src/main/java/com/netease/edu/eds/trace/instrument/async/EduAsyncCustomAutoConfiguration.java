...
@AutoConfigureBefore(EduAsyncDefaultAutoConfiguration.class)
...
public class EduAsyncCustomAutoConfiguration implements BeanPostProcessor {
	...
	public Object postProcessAfterInitialization(Object bean, String beanName)
			throws BeansException {
		if (bean instanceof AsyncConfigurer && !(bean instanceof EduLazyTraceAsyncCustomizer)) {
			AsyncConfigurer configurer = (AsyncConfigurer) bean;
			return new EduLazyTraceAsyncCustomizer(this.beanFactory, configurer);
		}
		return bean;
	}
